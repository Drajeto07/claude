  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <input
        ...
        required
        className="w-full rounded-lg border border-zinc-300 bg-white p-4 text-sm text-zinc-900 shadow-sm file:mr-4 file:rounded-full file:border-0 file:bg-accent file:px-4 file:py-2 file:text-sm file:font-medium file:text-accent-foreground dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      />
