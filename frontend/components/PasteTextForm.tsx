  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <textarea
        ...
        className="w-full rounded-lg border border-zinc-300 bg-white p-4 font-mono text-sm text-zinc-900 shadow-sm focus:border-accent focus:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
      />
